...
# Все падежные формы: «Российская Федерация» (им.), «Российской Федерации»
# (род./дат./предл. — совпадают у этого прилагательного+сущ.), «Российскую
# Федерацию» (вин.), «Российской Федерацией» (тв.). 23.09.2026: сравнение
# только с именительным падежом пропускало склонённые вхождения («Российской
# Федерации» в реальном контракте оставалась в найденных сущностях как person
# и утекала в файл — падёж не совпадал со строкой в множестве).
...
class NatashaDetector:
    ...
    source = Source.NER
    priority = 50
    types: frozenset[str] = frozenset(LABEL_TO_TYPE.values())
