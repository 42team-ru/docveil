...
VERIFIER_TYPES: frozenset[str] = frozenset(
    {EntityType.PERSON, EntityType.ORG_NAME, EntityType.ADDRESS}
)
...
_ADDRESS_FRAGMENT_RE = re.compile(r"\b(?:обл\.?|г\.?|ул\.?|пр-т)\b", re.IGNORECASE)
