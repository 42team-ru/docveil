...
class State(TypedDict, total=False):
    ...
    #: Следует ли завершить прогон после применённых правок. Значение приходит
    #: из конверта ``ask_review``: обычное утверждение завершает тред, а
    #: перегенерация возвращает его на следующую паузу проверки.
    review_finalize: bool
