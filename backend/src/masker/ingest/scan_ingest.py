...
#: 400 dpi — повышено с 300 для лучшего распознавания мелких глифов и
#: разреженных блоков на реальных сканах. При 300 dpi PP-OCRv5 пропускал
#: верхние строки шапки на некоторых офисных протоколах.
_OCR_DPI: int = 400
