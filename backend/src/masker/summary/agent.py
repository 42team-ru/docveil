...
# 12.09.2026: в school.pdf три короткие формулы «оплата по факту оказания
# услуг» имеют 47--55 символов и являются самостоятельным способом расчёта,
# хотя не содержат срок или аванс. Считаем «по факту» этапом, чтобы Д3 не
# теряла единственное условие после отсечения 313-символьного абзаца.
