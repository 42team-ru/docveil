...
def test_contract_amount_emits_price_vat_and_advance_as_summary_candidates() -> None:
    """Селектор карточки получает соседние суммы, а не подменяет цену первой из них."""
    text = (
...
def test_penalty_reference_rates_are_not_money_or_contract_amount() -> None:
    ...
    text = (
        ...
        "б) 5 процентов цены Контракта, если цена Контракта составляет от 3 млн. рублей до 50 млн. рублей; "
        "в) 1 процент цены Контракта, если цена Контракта составляет от 50 млн. рублей до 100 млн. рублей; "
        "г) 0,5 процента цены Контракта, если цена Контракта составляет от 100 млн. рублей до 500 млн. рублей; "
        "д) 0,4 процента цены Контракта, если цена Контракта составляет от 500 млн. рублей до 1 млрд. рублей; "
        "е) 0,3 процента цены Контракта, если цена Контракта составляет от 1 млрд. рублей до 2 млрд. рублей; "
        "ж) 0,25 процента цены Контракта, если цена Контракта составляет от 2 млрд. рублей до 5 млрд. рублей; "
        "з) 0,2 процента цены Контракта, если цена Контракта составляет от 5 млрд. рублей до 10 млрд. рублей; "
