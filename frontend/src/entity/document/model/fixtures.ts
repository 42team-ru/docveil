...
export const reportStats: ReportStat[] = [
  { label: "ВСЕГО ЗАМЕН", value: "28", note: "9 типов данных" },
  { label: "ПОДТВЕРЖДЕНО", value: "24", note: "вручную оператором" },
  { label: "ТРЕБУЮТ ВНИМАНИЯ", value: "4", note: "2 из OCR-страниц" },
  { label: "ВРЕМЯ ОБРАБОТКИ", value: "41 с", note: "14 стр. · локально" },
];
...
export const reportRows: ReportRow[] = [
  ...
  },
  {
    ...
    page: "12",
    type: "ФИО (OCR)",
    original: "Смирнова Ольга Игоревна",
    marker: "[ФИО_2]",
    side: "покупатель",
    status: "проверить",
  },
