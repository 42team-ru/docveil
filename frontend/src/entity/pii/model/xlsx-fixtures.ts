...
const rawPayload = {
  ...
  chunks: [
    ...
    cellChunk(3, 3, "[ФИО-1]", "XG1", "person", "Соколова Мария Владимировна", 0.96),
    ...
    cellChunk(4, 3, "[ФИО-2]", "XG5", "person", "Дмитриев Олег Игоревич", 0.95),
    ...
    cellChunk(5, 3, "[ФИО-3]", "XG8", "person", "Кузнецова Анна Сергеевна", 0.95),
    ...
    // Строка 6 — Аналитик
    cellChunk(6, 3, "[ФИО-4]", "XG12", "person", "Захаров Никита Павлович", 0.95),
    ...
    cellChunk(7, 3, "[ФИО-5]", "XG15", "person", "Волкова Елена Дмитриевна", 0.41),
